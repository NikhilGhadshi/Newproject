      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="images/i.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4" style="height: 145px">
            <h2 class="text-black font-weight-light mb-4">Pratiksha Angchekar</h2>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="images/i.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4" style="height: 145px">
            <h2 class="text-black font-weight-light mb-4">Bhagyashree Gangan</h2>
            <p>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="images/i.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4" style="height: 145px">
            <h2 class="text-black font-weight-light mb-4">Nikhil Ghadshi</h2>
            <p>
